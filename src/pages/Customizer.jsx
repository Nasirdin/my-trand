...
const Customizer = ({openModal, setOpenModal}) => {
        ...
        <>
          ...
          >
            <div className="flex flex-col items-end">
              <div>
                <a href="https://ai-am.vercel.app/">
                  {" "}
                  <button className="px-2 py-1.5 flex-1 ml-9 rounded-md text-white font-bold bg-[#056f27]">
                    Go back
                  </button>
                </a>
                <button onClick={() => {
                  setOpenModal(!openModal)
                }} className="px-2 py-1.5 flex-1 ml-[10px] rounded-md text-white font-bold bg-[#056f27]">Заказать</button>
              </div>

              {isButtonVisible && (
                <img
                  onClick={openPopup}
                  className="w-[33px] mr-[30px] mt-2"
                  src={id}
                />
              )}
                  ...
                  <div className="bg-white w-[200px] h-[200px] rounded ">
                    <div className="flex items-center justify-around m-2  ">
                      <a href="https://everpray-timadev00.vercel.app/">
                        <img className="m-2 left-0" src={maker} alt="make" />
                      </a>
